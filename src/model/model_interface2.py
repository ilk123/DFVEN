...
from utils import save_seqence, show_degrade, count_param, save_loss
...
class DMInterface(pl.LightningModule):
    ...
    def on_train_epoch_start(self):
        self.data_type = self.degrade_type[3]
    ...
    def on_train_end(self):
        torch.save(self.model.state_dict(), self.hparams.gen_lp[0])
...
class MInterface(pl.LightningModule):
    ...
    def on_train_start(self):
        ...
        #     D_state_dict = torch.load(self.hparams.gen_lp[0])
